...
// as a user to give you 1-10 num
// print the String version of given number
// Ex: 5 0
//print Five not valid
//But make reusable
public class NumberWords {
    public static void main(String[] args) {
        ...
        System.out.println( numAsWord2(userInput) ); // since it si RETURN method, can use in print statement
